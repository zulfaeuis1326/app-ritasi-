    ...
    <div className="container">
      ...
      {canClickRitasi && (
        <div className="card">
          ...
          {isAdmin ? (
            <>
              ...
              {selectedUnit && (
                <button
                  className="btn"
                  style={{ background: "transparent", color: "var(--danger)", border: "1px solid var(--danger)", marginTop: 10, marginBottom: 10 }}
          ...
          <Combobox
            ...
            options={
              recap && recap.shift
                ? buildSelectableHours(recap.shift.shift_type, recap.currentHour)
                    .filter(function (h) { return h !== recap.currentHour; })
                    .map(function (h) { return { value: String(h), label: String(h).padStart(2, "0") + ":00 (kelewat)" }; })
                : []
            }
            placeholder="Pilih jam..."
            emptyLabel={"Sekarang (" + (recap ? String(recap.currentHour).padStart(2, "0") + ":00" : "-") + ")"}
          />
          {selectedJam !== "" && (
      ...
      <div className="card">
        ...
        <div className="hint" style={{ marginBottom: 8 }}>
          ...
          {canMonitorAll && hiddenUnitCount > 0 && !showAllUnits && (
